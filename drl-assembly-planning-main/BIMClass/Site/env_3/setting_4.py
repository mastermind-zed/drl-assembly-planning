...
class site():
    ...
    def init_component(self):
        ...
        # #
        # # # ONE UNIT STRUCTURE
        sco4 = SCO(4, 'column', 8, 1, 1, 11, 1, 1, 13, 9, 1, 13, 9, 4, 4, [[0, 1, 1], [6, 1, 2]])
        self.scos.append(sco4)
        sco5 = SCO(5, 'column', 8, 2, 1, 11, 2, 1, 13, 13, 1, 13, 13, 4, 4, [[0, 1, 1], [7, 2, 2]])
        self.scos.append(sco5)
        sco6 = SCO(6, 'beam', 8, 3, 1, 10, 3, 1, 10, 9, 4, 12, 9, 4, 3, [[2, 2, 1], [4, 2, 2]])
        self.scos.append(sco6)
        sco7 = SCO(7, 'beam', 8, 4, 1, 10, 4, 1, 13, 10, 4, 13, 12, 4, 3, [[4, 2, 1], [5, 2, 2]])
        self.scos.append(sco7)
        sco8 = SCO(8, 'beam', 11, 4, 1, 13, 4, 1, 10, 13, 4, 12, 13, 4, 3, [[3, 2, 1], [5, 2, 2]])
