...
class site():
    def __init__(self, width, length, height):
        ...
        #construction area
        self.construction_x = [ 7, 8, 9, 10, 11,]
        self.construction_y = [9, 10, 11, 12, 13]
        self.site_list = []
        ...
        self.sco_index = 0
        self.arrived_scos = []
        self.tar_list = [[9, 10, 4, 9, 12, 4],[9, 9, 1, 9, 9, 4],[9, 13, 1, 9, 13, 4]]
    ...
    def init_component(self):
        ...
        # FRAME
        sco1 = SCO(1, 'beam', 4, 4, 1, 6, 4, 1, 9, 10, 4, 9, 12, 4, 3, [[2,2,1],[3,2,2]], train_on=False)
        self.scos.append(sco1)
        # sco2 = SCO(2, 'column', 7, 3, 1, 4, 3, 1, 9, 9, 1, 9, 9, 4, 4, [[0,1,1],[1,1,2]],train_on=False)
        # self.scos.append(sco2)
        sco3 = SCO(3, 'column', 7, 2, 1, 4, 2, 1, 9, 13, 1, 9, 13, 4, 4, [[0,1,1],[1,2,2]], train_on=False)
        self.scos.append(sco3)
        # #
        # # # ONE UNIT STRUCTURE
        # self.site_3D[0][13][9] = 'foundation'
        # self.site_3D[0][13][13] = 'foundation'
        # sco4 = SCO(4, 'column', 4, 10, 1, 4, 13, 1, 13, 9, 1, 13, 9, 4, 4, [[0, 1, 1], [6, 1, 2]])
        # self.scos.append(sco4)
        # sco5 = SCO(5, 'column', 3, 9, 1, 3, 12, 1, 13, 13, 1, 13, 13, 4, 4, [[0, 1, 1], [7, 2, 2]])
        # self.scos.append(sco5)
        # sco6 = SCO(6, 'beam', 12, 2, 1, 12, 4, 1, 10, 9, 4, 12, 9, 4, 3, [[2, 2, 1], [4, 2, 2]])
        # self.scos.append(sco6)
        # sco7 = SCO(7, 'beam', 14, 3, 1, 14, 5, 1, 13, 10, 4, 13, 12, 4, 3, [[4, 2, 1], [5, 2, 2]])
        # self.scos.append(sco7)
        # sco8 = SCO(8, 'beam', 9, 4, 1, 11, 4, 1, 10, 13, 4, 12, 13, 4, 3, [[3, 2, 1], [5, 2, 2]])
        ...
        choose_position = random.randint(1, 2)
        if choose_position == 1:
            sco2 = SCO(2, 'column', 9, 7, 1, 9, 7, 4, 9, 9, 1, 9, 9, 4, 4, [[1, 1, 2]])
            self.site_3D[2][9][9] = 100
            self.site_3D[3][9][9] = 100
            self.site_3D[1][9][9] = 200
            self.site_3D[4][9][9] = 100
            sco2.arrived = True
            sco2.node1_assembly = True
            self.scos.append(sco2)
        else:
            sco2 = SCO(2, 'column', 9, 7, 1, 9, 7, 4, 9, 9, 1, 9, 9, 4, 4, [[1, 1, 2]])
            self.site_3D[2][9][13] = 100
            self.site_3D[3][9][13] = 100
            self.site_3D[1][9][13] = 200
            self.site_3D[4][9][13] = 100
            sco2.arrived = True
            sco2.node1_assembly = True
            self.scos.append(sco2)
        # sco2 = SCO(2, 'column', 9, 7, 1, 9, 7, 4, 9, 7, 1, 9, 7, 4, 4, [[1, 1, 2]])
        # self.site_3D[2][9][9] = 100
        # self.site_3D[3][9][9] = 100
        # self.site_3D[1][9][9] = 200
        # self.site_3D[4][9][9] = 100
        ...
        # sco2.node1_assembly = True
        # self.scos.append(sco2)
        # sco3 = SCO(3, 'column', 9, 11, 1, 9, 11, 4, 9, 11, 1, 9, 11, 4, 4, [[1, 2, 2]])
        # self.site_3D[2][9][13] = 100
        # self.site_3D[3][9][13] = 100
        # self.site_3D[1][9][13] = 200
        # self.site_3D[4][9][13] = 100
        # sco3.arrived = True
        # sco3.node1_assembly = True
        # self.scos.append(sco3)
    ...
    def check_above(self,sco):
        ...
        if sco.z_1 < sco.z_2:
            ...
            z = sco.z_1
        # print('sco direct', sco.direction)
        # print('x1: {}, y1: {},z1: {},x2: {},y2: {},z1: {}'.format(sco.x_1,sco.y_1,sco.z_1,sco.x_2,sco.y_2,sco.z_2))
        if sco.direction == "NS":
            if sco.z_1 < self.s_he - 1:
                blank_count = 0
