...
class site():
    def __init__(self, width, length, height):
        ...
        self.sco_index = 0
        self.arrived_scos = []
        self.tar_list = [[6, 13, 4, 8, 13, 4,],[ 6, 9, 4, 8, 9, 4,],[5, 10, 4, 5, 12, 4,],[5, 13, 1, 5, 13, 4,],[5, 9, 1, 5, 9, 4,],[9, 10, 4, 9, 12, 4], [9, 9, 1, 9, 9, 4], [9, 13, 1, 9, 13, 4],[13, 9, 1, 13, 9, 4,], [13, 13, 1, 13, 13, 4,], [10, 9, 4, 12, 9, 4,],[13, 10, 4, 13, 12, 4,], [10, 13, 4, 12, 13, 4,]]
    ...
    def init_component(self):
        ...
        sco9 = SCO(9, 'column', 4, 1, 1, 7, 1, 1, 5, 9, 1, 5, 9, 4, 4, [[0, 1, 1], [12, 1, 2]])
        self.scos.append(sco9)
        sco10 = SCO(10, 'column', 8, 1, 1, 11, 1, 1, 5, 13, 1, 5, 13, 4, 4, [[0, 1, 1], [12, 2, 2]])
        ...
        # two unit
        sco12 = SCO(12, 'beam', 4, 6, 1, 6, 6, 1, 5, 10, 4, 5, 12, 4, 3, [[9, 2, 1], [10, 2, 2]])
        self.scos.append(sco12)
        sco1 = SCO(1, 'beam', 4, 4, 1, 6, 4, 1, 9, 10, 4, 9, 12, 4, 3, [[2, 2, 1], [3, 2, 2]])
        self.scos.append(sco1)

        #
        sco11 = SCO(11, 'beam', 4, 5, 1, 6, 5, 1, 6, 9, 4, 8, 9, 4, 3, [[2, 2, 1], [9, 2, 2]])
        self.scos.append(sco11)

        sco13 = SCO(13, 'beam', 3, 4, 1, 3, 6, 1, 6, 13, 4, 8, 13, 4, 3, [[3, 2, 1], [10, 2, 2]])
